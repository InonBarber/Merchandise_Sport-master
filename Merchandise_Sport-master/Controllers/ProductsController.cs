...
namespace Merchandise_Sport_master.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(Merchandise_Sport_masterContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SerialNumber,Title,Size,Price,Image,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SerialNumber,Title,Size,Price,Image,CategoryId")] Product product)
        {
            if (id != product.SerialNumber)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ProductExists(product.SerialNumber))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Product.Any(e => e.SerialNumber == id);
        }
    }
}
